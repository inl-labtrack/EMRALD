/**
 * @file Custom WindowFrame functionality.
...
var WindowFrame = (function (_super) {
  ...
  /**
   * Constructs WindowFrame.
   * 
   * @class WindowFrame
   * @classdesc Custom WindowFrame functionality.
   * @augments mxWindow
   * @constructs
  ...
  function WindowFrame(title, content, x, y, width, height, minimizable, movable, replaceNode, style, ismodal, z_index) {
    /**
     * The z-index of the window frame.
     * 
     * @name WindowFrame#z_index
     * @type {number}
     */
    ...
    /**
     * If the window frame is a modal.
     * 
     * @name WindowFrame#isModal
     * @type {number}
     */
...
/**
 * Default behavior for command buttons.
 * 
 * @param {string} btnStatus The button type.
 * @param {Function} callHomeFn Callback function.
 * @param {mxEvent} evt The click event.
 * @returns {boolean} The window status.
 */
